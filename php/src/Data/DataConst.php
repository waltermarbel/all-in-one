...
class DataConst {
    /**
     * ⚡ Bolt: Cache static directory paths.
     * In Nextcloud AIO, data and session directories are statically mounted Docker volumes.
     * Caching them avoids redundant filesystem checks during a request lifecycle.
     */
