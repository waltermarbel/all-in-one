...
class DataConst {
    /**
     * ⚡ Bolt: Cache resolved directory paths to prevent repeated disk I/O (is_dir/realpath)
     * during the request lifecycle since these paths are constant.
     */
    ...
    public static function GetDataDirectory() : string {
        ...
        if(is_dir('/mnt/docker-aio-config/data/')) {
            ...
            self::$dataDirectoryCache = (string)realpath(__DIR__ . '/../../data/');
        }
    ...
    public static function GetSessionDirectory() : string {
        ...
        if(is_dir('/mnt/docker-aio-config/session/')) {
            ...
            self::$sessionDirectoryCache = (string)realpath(__DIR__ . '/../../session/');
        }
