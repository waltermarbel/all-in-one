...
class DataConst {
    /**
     * ⚡ Bolt: Cache directory paths to avoid repeated is_dir and realpath I/O checks
     * since these statically mounted volumes do not change during a request lifecycle.
     */
